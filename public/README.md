...
app/                        --> all of the source files for the application
  ...
  customer_detail/          --> the cyustomer_detail view template and logic
    customer_detail.html    --> the partial template
    customer_detail.js      --> the controller logic
    custoemr_detail_test.js --> tests of the controller
...
[Jasmine][jasmine], which is run with the [Karma Test Runner][karma]. A Karma
...
don't require a backend server at all, it is recommended that project files are served using a local
